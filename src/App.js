...
const videoUrls = [
  {
    ...
    username: 'csnupur',
    description: 'computer science girls aesthetics',
    song: 'Original sound',
    likes: 4303,
    comments: 132,
    saves: 23,
  ...
  },
  {
    ...
    username: 'jfkdsnjdfjk',
    description: 'Always Busy',
    song: 'Original sound',
    likes: '13.4K',
    comments: 3121,
    saves: 254,
  ...
  },
  {
    ...
    username: 'jskdkkdw',
    description: 'Wait for the end  #softwareengineer #softwareengineer #coding #codinglife #codingmemes ',
    song: 'Original sound',
    likes: 96589,
    comments: 2340,
    saves: 1037,
...
function App() {
  ...
  useEffect(() => {
    const observerOptions = {
      root: null,
      rootMargin: '0px',
      threshold: 0.9, // Adjust this value to change the scroll trigger point
    };
